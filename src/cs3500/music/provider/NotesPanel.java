...
public class NotesPanel extends JPanel {
   ...
   */
  public NotesPanel(List<MusicNote> notes, MusicNote highNote, MusicNote lowNote, int lastBeat) {
  ...
  public void setRange(MusicNote highNote, MusicNote lowNote) {
    this.highNote = highNote;
    this.lowNote = lowNote;
  }
  ...
  private String toneNumToString(int t) {
    String result = " ";
    Tone tone = new Tone(Pitches.values()[((t - 1) % 12)], ((t - 1) / 12));
